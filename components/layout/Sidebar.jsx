...
export function Sidebar({ storageMetrics = null }) {
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 h-screen fixed left-0 top-0 bg-slate-950 border-r border-slate-800/80 z-30 select-none">
      {/* Brand Header */}
      <div className="p-5 border-b border-slate-800/80">
        <Link href="/dashboard" className="block focus:outline-none focus:ring-2 focus:ring-teal-500 rounded-xl">
          ...
          return (
            <div key={item.name} className="space-y-1">
              ...
              {item.children && active && (
                <div className="pl-6 pr-1 py-1 space-y-1 border-l-2 border-teal-500/20 ml-5 my-1">
      ...
      <div className="p-4 border-t border-slate-800/80 space-y-3 bg-slate-950/60">
        ...
        <Link
          href="/storage"
          className="block p-3 rounded-xl bg-slate-900/60 border border-slate-800 hover:border-slate-700 transition-colors group"
        >
          <div className="flex items-center justify-between text-xs font-medium mb-1.5">
            ...
            <span className="text-slate-400 group-hover:text-teal-300 text-[11px]">
              {storageMetrics
        ...
        <div className="flex items-center justify-between pt-1">
          <div className="flex items-center gap-2.5 overflow-hidden">
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-teal-500 to-cyan-400 flex items-center justify-center text-slate-950 font-bold text-xs shrink-0">
