      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className={`w-full rounded-xl bg-slate-900/90 border ${
            error ? 'border-rose-500/80 focus:border-rose-400 focus:ring-rose-500/20' : 'border-slate-700/80 focus:border-teal-500 focus:ring-teal-500/20'
          } px-3.5 py-2.5 text-sm text-slate-100 placeholder:text-slate-500 transition-all duration-150 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:bg-slate-950 ${
            Icon ? 'pl-10' : ''
