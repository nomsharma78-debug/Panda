    ...
    corsPolicy: `[
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Under bucket details, note the S3 Endpoint (e.g. "s3.us-west-004.backblazeb2.com") and Region ("us-west-004").',
      },
      {
        title: 'Create Application Key',
        description: 'Go to "App Keys" -> click "Add a New Application Key". Select your bucket and enable "Read and Write" access.',
      },
      {
        title: 'Copy keyID & applicationKey',
        description: 'Copy your "keyID" (Access Key) and "applicationKey" (Secret Key), then paste them into Panda.',
      },
    ],
  },
  s3: {
