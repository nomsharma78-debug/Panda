...
export class S3CompatibleProvider extends StorageProvider {
  ...
  async testConnection() {
    ...
    try {
      ...
      // Directly testing upload is the most reliable cross-provider test
      // as it verifies endpoint reachability, credentials, bucket existence, and write permissions in one shot
      ...
      // 4. Test CORS configuration (Non-blocking check)
