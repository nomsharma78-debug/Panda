import { validateSessionToken, recordDeviceSession } from '../db/sessions.js';
  ...
  if (authHeader && authHeader.startsWith('Bearer ')) {
    ...
    try {
      ...
      if (userObj) {
        ...
        // Record or touch this device's active session in background
        recordDeviceSession(userObj.id, { userAgent, ipAddress: ip }).catch(() => {});
