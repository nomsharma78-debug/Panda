-- =========================================================================
-- PANDA DIGITAL VAULT — DATABASE SCHEMA REFERENCE
-- =========================================================================
-- NOTE: The single canonical source of truth for the database schema is:
--       migrations/001_initial_schema.sql
--
-- This file is maintained as a direct reference to the canonical migration.
-- To execute migrations against your database, run:
--       npm run db:migrate
-- =========================================================================
